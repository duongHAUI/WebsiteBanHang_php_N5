...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 23, 2022 lúc 08:29 AM
...
INSERT INTO `customer_orders` (`order_id`, `customer_id`, `amount`, `invoice_no`, `order_status`, `createdAt`, `updatedAt`) VALUES
(1, 2, 210, 93551031, 'Completed', '2022-05-22 03:16:48', '2022-05-22 03:16:59'),
(2, 2, 170, 93551031, 'Completed', '2022-05-22 03:16:48', '2022-05-22 03:16:59'),
(3, 2, 74, 93551031, 'Pending', '2022-05-22 03:16:48', '2022-05-22 03:16:59'),
(4, 1, 168, 41895869, 'Completed', '2022-05-22 03:16:48', '2022-05-22 03:16:59'),
(5, 1, 96, 41895869, 'Pending', '2022-05-22 03:16:48', '2022-05-22 03:16:59'),
(8, 2, 148, 1956213091, 'Pending', '2022-05-22 03:16:48', '2022-05-22 03:16:59');
...
--
-- Cấu trúc bảng cho bảng `procloth`
--
...
--
-- Đang đổ dữ liệu cho bảng `procloth`
--

INSERT INTO `procloth` (`product_id`, `cat_id`, `brand_id`, `product_title`, `product_price`, `discount`, `product_img`, `product_desc`, `product_keywords`, `createdAt`, `updatedAt`) VALUES
(1, 2, 1, 'Slim Fit Solid Men Bomber Jacket', 56, 0, '', 'This is a slim jacket for men with durable material and made in China', 'Bomber', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(2, 3, 2, 'Summer T-shirt Three Types For Men', 70, 0, '', 'This is a summer T-shirt with three types for men accompanied by high quality and reasonable price', 'Summer T-shirt', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(3, 1, 2, 'Men Fitness Hoodies Tank Tops Vest', 45, 0, '', 'This is a Men Fitness Hoodies Vest with three types for men accompanied by high quality and reasonable price', 'Tank Tops', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(4, 5, 2, 'Mens Overcoat Fashion Autumn Winter Button', 48, 0, '', 'This is a Men Overcoat Fashion Autumn Winter Button with three types for men accompanied by high quality and reasonable price', 'Overcoat', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(5, 5, 4, 'Winter Coat Women Work Solid Vintage', 80, 0, '', 'This is a Winter Coat Women with three types for women accompanied by high quality and reasonable price', 'Winter Coat', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(6, 1, 3, 'Women Vest Cotton Hooded', 100, 0, '', 'This is a Vest Cotton Hooded with three types for women accompanied by high quality and reasonable price', 'Vest Cotton', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(8, 3, 3, '3D printed Image Men T-shirt', 85, 0, '', '3D printed Image T-shirt for men with three types accompanied by high quality and reasonable price', '3D printed', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(9, 3, 4, '3D printed Image Clow Men T-shirt', 74, 0, '', 'This is the 3D printed Image Clow Men T-shirt with three types I have for you', 'Clow', '2022-05-22 03:41:23', '2022-05-22 03:41:35'),
(10, 3, 1, '3D printed Image Horror Men T-shirt', 82, 0, '', '<p><span style=\"font-size: 14px;\">3D printed Image T-shirt for men with three types accompanied by high quality and reasonable price</span></p>', 'Horror', '2022-05-22 03:41:23', '2022-05-22 03:41:35');
...
ALTER TABLE `cart`
  ...
  ADD KEY `FK_Cart_Procloth` (`pro_id`),
...
ALTER TABLE `order_details`
  ...
  ADD KEY `FK_Detail_Pro` (`product_id`),
...
--
-- AUTO_INCREMENT cho bảng `procloth`
--
ALTER TABLE `procloth`
...
ALTER TABLE `cart`
  ...
  ADD CONSTRAINT `FK_Cart_Procloth` FOREIGN KEY (`pro_id`) REFERENCES `procloth` (`product_id`);
...
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `FK_Detail_Order` FOREIGN KEY (`order_id`) REFERENCES `customer_orders` (`order_id`),
  ADD CONSTRAINT `FK_Detail_Pro` FOREIGN KEY (`product_id`) REFERENCES `procloth` (`product_id`);

--
-- Các ràng buộc cho bảng `procloth`
--
ALTER TABLE `procloth`
