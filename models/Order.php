...
class Order extends Model
{
    ...
    function __construct($row)
    {
        ...
        $this->payment_methods = $row["order_payment_methods"];
    ...
    function save($con)
    {
      ...
      order_payment_methods='$payment_methods', order_amount='$amount', 
    ...
    public static function create($con, $form)
    {
        ...
        $query = "insert into " . self::TABLE_NAME . "(order_receiver, order_address, order_payment_methods, 
              order_amount, order_phone, order_note, cus_id)
              values ('$receiver', '$address', '$payment_methods', '$amount', '$phone', '$note', '$cus_id')";
