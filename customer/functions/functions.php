				...
				<div class = 'col-md-4 col-sm-6 single'>
					<div class = 'product'>
						...
						<div class = 'text'>
							...
							<p class = 'button'>
								<a class = 'btn btn-default' href = 'Details.php?pro_id=$pro_id'>Detail</a>
	...
	function getcatpro(){
		...
		if (isset($_GET['cat'])) {
			...
			if ($count==0) {
				echo "
					<div class = 'box'>
						<h1>No clothing products found in this category</h1>
					</div>
				";
			}
			else{
	...
	function getbrandpro(){
		...
		if (isset($_GET['brand'])) {
			...
			if ($count==0) {
				echo "
					<div class = 'box'>
						<h1>No clothing products found in this brand</h1>
					</div>
				";
			}
			else{
